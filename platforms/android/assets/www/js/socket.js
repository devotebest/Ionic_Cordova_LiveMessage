 ...
 * License: MIT
 * modified for pubnub sockets by Joe Fatora http://joefatora.com
 */

'use strict';

angular.module('pubnub-sockets', []).
  provider('socket', function () {
    ...
    this.$get = function ($rootScope, $timeout) {
      ...
      var wrappedSocket = {
        ...
        send: function (eventName, namespace, data, callback) {
          if (callback) {
            socket.send(eventName, namespace, data, asyncAngularify(callback));
          } else {
